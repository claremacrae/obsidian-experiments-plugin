...
def convert_github_url(v1):
    ...
    github_repo_hyperlink = re.compile(r"""\[GitHub\ -\ ([A-Za-z\d)]+)/([a-z\d-]+)(:\ [A-Za-z\d :.\-,_()]+){0,1}]\(https://github.com/\1/\2\)""")
...
class LinkMungingTestCase(unittest.TestCase):
    ...
    #     v1 = r'[GitHub - maskiran/lightroom_collection_tree: Mirror the collection](https://github.com/maskiran/lightroom_collection_tree)'
    ...
    #     v2 = r'[maskiran/**lightroom_collection_tree**](https://github.com/maskiran/lightroom_collection_tree): Mirror the collection'
    #     self.check_conversion(v1, v2)
